...
export function SingIn() {
  ...
  return (
    <div className='w-screen h-screen px-2 bg-gray-900 flex flex-col items-center justify-center text-gray-100  '>
      ...
      <form onSubmit={(event) => handleSingIn(event)} className='flex gap-4 flex-col items-stretch w-full max-w-sm mt-10'>

        {isUserSingedIn && <Text>Login Realizado com sucesso!</Text>}
